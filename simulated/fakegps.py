...
def generate_gps_coordinates(lat=36.94496622, lon=-76.31333208, speed=30):
...
def fake_gps_movement(lat=36.94499622, lon=-76.31333208, speed=30, number_of_updates=600):
